...
"""
Cyber Ninja: Find Usernames Across Social Networks Module
...
import timg 
module_name = "Cyber Ninja: Find Usernames Across Social Networks"
__version__ = "1"


class cyberninjaFuturesSession(FuturesSession):
    def request(self, method, url, hooks={}, *args, **kwargs):
        ...
        return super(cyberninjaFuturesSession, self).request(method,
                                                           url,
                                                           hooks=hooks,
                                                           *args, **kwargs)
...
def cyberninja(username, site_data, query_notify,
             tor=False, unique_tor=False,
             proxy=None, timeout=None):
    """Run Cyber Ninja Analysis.
    ...
    session = cyberninjaFuturesSession(max_workers=max_workers,
